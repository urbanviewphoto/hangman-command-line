// Hangman CLI
//    Consists of 
//		Word 		hidden word the user must guess (computer assigend)
//    	Letter		a letter entered. 
//					if correct, show letter in proper position in word
//                  if not, do not change
//		Words		array of words that are used by the game 
//					and assigned randomly (for now will be 10 words)
//		Topic		words will be about this topic, also randomly assigned
//					this will act as the hint
//		bWord		blank representation of Word (_ _ _ _ _ _ )
